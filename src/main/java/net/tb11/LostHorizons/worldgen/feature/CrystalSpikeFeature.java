...
//USE THE EQUATION HERE: https://www.geogebra.org/calculator/fwdvgmty
public class CrystalSpikeFeature extends Feature<CrystalSpikeFeatureConfig>{
    ...
    private void generateFeature(Integer r, Integer h, BlockPos castPos, BlockState block) {
        Integer castX = castPos.getX();
        Integer castY = castPos.getY();
        Integer castZ = castPos.getZ();
    }
}
