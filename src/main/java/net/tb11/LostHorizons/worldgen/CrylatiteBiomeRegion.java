...
public class CrylatiteBiomeRegion extends Region {

    public CrylatiteBiomeRegion(Identifier name, int weight) {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>> mapper) {
        ...
        builder.add(noiseHypercube, LostHorizonsBiomes.CRYLATITE_CAVERNS);
