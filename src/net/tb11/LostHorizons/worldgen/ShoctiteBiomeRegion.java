...
public class ShoctiteBiomeRegion extends Region {

    public ShoctiteBiomeRegion(Identifier name, int weight) {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>> mapper) {
        ...
        builder.add(noiseHypercube, LostHorizonsBiomes.SHOCTITE_CAVERNS);
