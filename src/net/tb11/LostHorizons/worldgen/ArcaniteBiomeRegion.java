...
public class ArcaniteBiomeRegion extends Region {

    public ArcaniteBiomeRegion(Identifier name, int weight) {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>> mapper) {
        ...
        builder.add(noiseHypercube, LostHorizonsBiomes.ARCANITE_CAVERNS);
