...
public class NoxiteBiomeRegion extends Region {

    public NoxiteBiomeRegion(Identifier name, int weight) {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>> mapper) {
        ...
        builder.add(noiseHypercube, LostHorizonsBiomes.NOXITE_CAVERNS);
